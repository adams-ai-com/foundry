...
import { SlackImportWizard } from '@/components/SlackImportWizard'

export const dynamic = 'force-dynamic'

export default async function SlackImportPage() {
  ...
  return <SlackImportWizard foundryChannels={foundryChannels} recentJobs={recentJobs} />
}
