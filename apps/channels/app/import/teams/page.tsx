...
import { TeamsImportWizard } from '@/components/TeamsImportWizard'

export const dynamic = 'force-dynamic'

export default async function TeamsImportPage() {
  ...
  return <TeamsImportWizard foundryChannels={foundryChannels} recentJobs={recentJobs} />
}
