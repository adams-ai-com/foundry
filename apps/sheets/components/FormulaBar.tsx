...
export function FormulaBar({ selected }: FormulaBarProps) {
  ...
  return (
    <div className="flex items-center border-b border-gray-200 bg-white h-8 text-sm">
      <div className="px-2 border-r border-gray-200 text-gray-500 font-mono text-xs w-16 text-center flex-shrink-0">
      ...
      <div className="flex items-center px-2 gap-1 flex-1">
        ...
        <span className="font-mono text-xs text-gray-700 truncate">{display}</span>
      </div>
    </div>
  )
}
