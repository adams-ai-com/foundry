...
const APPS = [
  { label: 'Docs',     desc: 'Rich text editing with comments, version history, and collaborative blocks.',  Icon: DocsIcon,     ic: 'text-blue-500',    bg: 'bg-blue-500/10' },
  { label: 'Sheets',   desc: 'Spreadsheets with formulas, charts, pivot tables, and Python scripting.',      Icon: SheetsIcon,   ic: 'text-emerald-500', bg: 'bg-emerald-500/10' },
  { label: 'Mail',     desc: 'Email client backed by our own SMTP server. Own your inbox entirely.',          Icon: MailIcon,     ic: 'text-violet-500',  bg: 'bg-violet-500/10' },
  { label: 'Channels', desc: 'Real-time team chat with threads, video calls, and AI conversation memory.',   Icon: ChannelsIcon, ic: 'text-sky-500',     bg: 'bg-sky-500/10' },
  { label: 'Wiki',     desc: 'Structured knowledge base with nested pages and workspace-wide search.',       Icon: WikiIcon,     ic: 'text-amber-500',   bg: 'bg-amber-500/10' },
  { label: 'Sites',    desc: 'Internal sites, file management, and team portals — all in one place.',        Icon: SitesIcon,    ic: 'text-rose-500',    bg: 'bg-rose-500/10' },
  { label: 'PDF',      desc: 'Edit, annotate, sign, and redact PDFs. An open-source Acrobat Pro.',           Icon: PDFIcon,      ic: 'text-orange-500',  bg: 'bg-orange-500/10' },
]
